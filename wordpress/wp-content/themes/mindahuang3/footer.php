...
<div class="container">
	...
	<?php
		...
		$zerif_email = get_theme_mod('zerif_email','support@mindahuang.org');
		$zerif_email_icon = get_theme_mod('zerif_email_icon',get_template_directory_uri().'/images/envelope4-green.png');
		$zerif_phone = get_theme_mod('zerif_phone','021-54740000');
		...
		!empty($zerif_copyright)):
					...
					echo '<div class="zerif-copyright-box"><a class="zerif-copyright" href="https://themeisle.com/themes/zerif-lite/" target="_blank" rel="nofollow">Zerif Lite </a>'.__('powered by','mindahuang3').'<a class="zerif-copyright" href="http://wordpress.org/" target="_blank" rel="nofollow"> WordPress</a></div>';
					echo '</div>';
		endif;
	?>
</div> <!-- / END CONTAINER -->
